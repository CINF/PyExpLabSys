""" Driver for Edwards, nXDS pumps0 """
...
class edwards_nXDS():
    ...
    def read_status(self):
        ...
        if system_status_1[11] is True:
            messages.append('Above ramp speed')
...
if __name__ == '__main__':
    ...
    print('----')
    print(PUMP.read_status())
    #print(PUMP.set_run_state(False))
    #print(PUMP.read_status())
    #print(PUMP.read_status())
    #time.sleep(20)
    #print(PUMP.set_run_state(False))
