...
class OxfordMercury():
    ...
    def temperature_setpoint(self, uid: str, setpoint: float = None, rate: float = None) -> float:
        ...
        # print()
        # cmd = 'READ:DEV:DB1.H1:HTR?'.format(uid)
        # raw_reply = self.instr.query(cmd)
        # print(cmd)
        # print(raw_reply)
        
        # print()
        # cmd = 'READ:DEV:DB1.H1:HTR:SIG?'.format(uid)
        # raw_reply = self.instr.query(cmd)
        # print(cmd)
        # print(raw_reply)

        # print()
        # cmd = 'SET:DEV:DB1.H1:HTR:SIG:PERC:1.0%'
        # raw_reply = self.instr.query(cmd)
        # print(cmd)
        # print(raw_reply)
        ...
        # print()
        # # cmd = 'READ:DEV:DB1.H1:HTR:SIG:POWR?'
        # cmd = 'READ:DEV:DB1.H1:HTR'
        # print(cmd)
        # print(self.instr.query(cmd))

        # print()
        # # cmd = 'READ:DEV:DB1.H1:HTR:SIG:POWR?'
        # cmd = 'READ:DEV:DB1.H1:HTR:SIG?'
        # print(cmd)
        # print(self.instr.query(cmd))
