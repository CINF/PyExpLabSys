...
class Bronkhorst(object):
    ...
    def __init__(self, max_flow, serial, node_channel):
...
if __name__ == '__main__':
    ...
    bh_arr = []
    bh_arr.append(Bronkhorst(100, ser1, hex(10)))
    bh_arr.append(Bronkhorst(100, ser1, hex(20)))
    bh_arr.append(Bronkhorst(100, ser1, hex(30)))
    bh_arr.append(Bronkhorst(100, ser2, hex(40)))
