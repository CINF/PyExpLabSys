...
LOGGER = get_logger(
    'Turbo Pump', level='info', file_log=True, file_name='turbo.log', terminal_log=False
)
...
def main():
    ...
    codenames = [
        settings.table_prefix + '_turbo_speed',
    ...
    socket = DateDataPullSocket(
        settings.name + '-turboreader',
        codenames,
