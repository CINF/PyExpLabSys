...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.intersphinx', 'sphinx.ext.ifconfig', 'sphinx.ext.viewcode', 'sphinx.ext.todo', 'sphinx.ext.inheritance_diagram']
...
htmlhelp_basename = 'PyExpLabSysdoc'
