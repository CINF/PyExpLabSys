...
class RtdCalibrator(object):
    ...
    def __init__(self, connection_string, temperature_host=None, only_4w=False):
...
if __name__ == '__main__':
    ...
    CALIBRATOR = RtdCalibrator('USB0::0x0957::0x2007::MY57000209::INSTR', only_4w=True, temperature_host='rasppi88')
    for i in range(0, 1):
        CALIBRATOR.update_values()
        print(CALIBRATOR.data)
        

    CALIBRATOR.start_measurement(comment='2.1')
