...
if __name__ == "__main__":
    ...
    for i in range(0, 21): #Set GPIO pins to output
        wp.pinMode(i, 1)
        wp.digitalWrite(i, 0)

    wp.digitalWrite(20, 1) # Now that all output are low, we can open main safety output

    HOST, PORT = "10.54.7.29", 9999 #Rasppi32
